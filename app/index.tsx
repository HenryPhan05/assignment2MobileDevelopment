...
export default function HomeScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    stickyHeader: {
      backgroundColor: dark ? '#171717' : "#fffdfd",
      paddingBottom: 5,
    },
    header: {
  ...
  return (
    <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} style={styles.body} >
      ...
      <View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} >{/* radioes */}
          {radios.map((radio) => (
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}> {/* Albums section */}
          {albums.map((album) => (
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}> {/*Favourite Artists section */}
