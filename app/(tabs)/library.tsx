...
export default function LibraryTab() {
  ...
  const styles = StyleSheet.create({
    ...
    bottomHeaderBtn: {
      color: 'white',
      backgroundColor: dark ? '#474747' : '#2b2b2b',
      padding: 8,
      paddingLeft: 10,
      paddingRight: 10,
      borderRadius: 100,
    ...
    iconDownload: {
      backgroundColor: dark ? '#ddd4d4a2' : "#464545a2",
      color: 'white',
      width: 50,
      height: 50,
      textAlign: 'center',
    ...
    <ScrollView showsHorizontalScrollIndicator={false} style={styles.body}>
      <View > {/**header */}
        <View style={styles.topHeader}> {/**top header */}
          ...
          <MaterialIcons name='search' size={30} color={dark ? 'white' : 'black'} />
          <MaterialIcons name='add' size={30} color={dark ? 'white' : 'black'} />
        </View>
        ...
        <View style={styles.sortSection}> {/**sort section */}
          <Text style={styles.sortBtn} ><MaterialIcons name='sort' size={12} color={dark ? 'white' : 'black'} /> Recents</Text>
          <MaterialIcons name='apps' size={15} color={dark ? 'white' : 'black'} />
        </View>
      </View>
